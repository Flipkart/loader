...
/**
 * Does Http Put Operation
 */
public class HttpPut extends PerformanceFunction implements Constants {
    ...
    public void execute(FunctionContext context) throws Exception {
        AsyncHttpClient.BoundRequestBuilder requestBuilder = asyncHttpClient.
                preparePut(context.getParameterAsString(IP_PARAM_URL));
    ...
    public List<String> description() {
        return Arrays.asList(new String[]{
                "This Performance function is useful in doing Http Put Operation",
