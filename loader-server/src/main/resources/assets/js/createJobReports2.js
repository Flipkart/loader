ko.bindingHandlers.graphsInitialization = {
    update: function(element, valueAccessor, allBindings, viewModel, bindingContext){
        console.log("calling graphsInitialization");
...
ko.bindingHandlers.addSlider = {
    update: function(element, valueAccessor, allBindings, viewModel, bindingContext){
        ...
        if(valueUnWrapperd){
            ...
            console.log("added slider to ", element);
        }
    }
}
...
var groupsGraphViewModel = function(jobStats) {
    ...
    self.showGraphs = function(){
        self.isVisible(true);
        //console.log("making graph div visible");
...
var countersGraphViewModel = function(counters, functionUrl){
    ...
    self.fetchAndParse = function(){
        ...
        console.log("after fetch counter data", self.countersData);
    ...
    self.plot = function(currElement, chartIndex){
        ...
        console.log("plotting", chart1, chart2);
        if(chartIndex==1){
...
var resourceGraphsViewModel = function(resource, url){
    ...
    self.fetchAndParse = function(){
        $.ajax({
            ...
            success: function(resStats) {
                ...
                console.log("resourceData", self.resourceData);
                ...
                console.log("this is the data i am plotting", self.resourceMapsData);
            },
            error: function() {
            },
            complete: function() {
    ...
    self.plot = function(k, currElement){
        ...
        console.log("resourceMapsData[k]", self.resourceMapsData[k]);
