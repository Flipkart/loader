...
(function($){
      ...
      _initMouseHandling:function(){
        ...
        var handler = {
          moved:function(e){
            ...
            }else if ($.inArray(nearest.node.name, ['Loader2.0','code','Docs','Home']) >=0 ){
  ...
  $(document).ready(function(){
    ...
    var theUI = {
      nodes:{"Loader2.0":{color:"red", shape:"dot", alpha:1}, 
      
             Home:{color:CLR.branch, shape:"dot", alpha:1}, 
             Runs:{color:CLR.demo, alpha:0, link:'/list_jobs.html'},
             Jobs:{color:CLR.demo, alpha:0, link:'/home.html'},
             Upload:{color:CLR.demo, alpha:0, link:'/upload_jar.html'},

             Docs:{color:CLR.branch, shape:"dot", alpha:1}, 
             Introduction:{color:CLR.doc, alpha:0, link:'https://github.com/Flipkart/loader2.0/wiki/Features'},
             Architecture:{color:CLR.doc, alpha:0, link:'https://github.com/Flipkart/loader2.0/wiki/Hand-Drawn-Architecture'},
             "Write UDFs":{color:CLR.doc, alpha:0, link:'https://github.com/Flipkart/loader2.0/wiki/How-to-write-UDF'},
             "Setup":{color:CLR.doc, alpha:0, link:'https://github.com/Flipkart/loader2.0/wiki/Getting-Started-Locally'},

             code:{color:CLR.branch, shape:"dot", alpha:1},
             github:{color:CLR.code, alpha:0, link:'https://github.com/Flipkart/loader2.0'},
